...
- [ ] T-017: Dashboard test harness stub — `tests/grafana/` placeholder (dashboard JSON query tests) wired into CI-full. The integration job in `.github/workflows/ci-full.yml` is shaped to append the `tests/grafana` path once it exists. Spec: §17.6, §19 F0 bullet 10
